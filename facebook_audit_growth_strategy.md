...
graph TD
    ...
    P2 -->|Showcases| Engineering[Custom Route Surveys]
    
    P3[Pillar 3: Specialized Cold Chain] -->|Showcases| Pharma[Strict Temperature Integrity]
    P3 -->|Showcases| Audits[WHO & compliance tours]
    
    P4[Pillar 4: B2B Thought Leadership] -->|Showcases| FTWZ[Duty Deferment Cost-Savings]
    P4 -->|Showcases| CaseStudies[Transit Time Reductions]
```
